...
nowBest.lossWeightTree['self_recon'].weight = (
    2 * RESOLUTION ** 2 * SEQ_LEN * nowBest.batch_size
)
nowBest.lossWeightTree['kld'].weight = 0.01 * nowBest.batch_size
nowBest.lossWeightTree['predict']['z'].weight = (
    2 * nowBest.symm.latent_dim * SEQ_LEN * nowBest.batch_size
)
nowBest.lossWeightTree['predict']['image'].weight = (
    2 * 2 * RESOLUTION ** 2 * SEQ_LEN * nowBest.batch_size
)
