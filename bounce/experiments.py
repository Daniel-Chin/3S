...
EXPERIMENTS = [
    ('VAE', Config(
        Constant(1e-8), 1, 0, do_symmetry=False, 
        variational_rnn=False, rnn_width=32, 
        deep_spread=False, vae_channels=[16, 32, 64], 
    )), 
    ('VAE', Config(
        Constant(1e-7), 1, 0, do_symmetry=False, 
        variational_rnn=False, rnn_width=32, 
        deep_spread=False, vae_channels=[16, 32, 64], 
    )), 
    ('VAE', Config(
        Constant(1e-6), 1, 0, do_symmetry=False, 
        variational_rnn=False, rnn_width=32, 
        deep_spread=False, vae_channels=[16, 32, 64], 
    )), 
    ('VAE', Config(
        Constant(1e-5), 1, 0, do_symmetry=False, 
        variational_rnn=False, rnn_width=32, 
        deep_spread=False, vae_channels=[16, 32, 64], 
    )), 
    ('VAE', Config(
        Constant(1e-4), 1, 0, do_symmetry=False, 
        variational_rnn=False, rnn_width=32, 
        deep_spread=False, vae_channels=[16, 32, 64], 
    )), 
]
